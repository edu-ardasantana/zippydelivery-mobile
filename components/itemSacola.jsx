...
import { useMyContext } from '../views/myContext';
        ...
        <View style={styles.slide}>
            ...
            <View style={styles.line4 }>
                <TouchableOpacity onPress={()=>delToCart({...item, quantity: selectedQuantity })} style={styles.button}>
                    <Image style={[styles.icon, { width: 16 }]} source={require("../assets/images/iconFooter/material-symbols--remove-rounded.png")} />
                </TouchableOpacity>
                ...
                <TouchableOpacity onPress={()=>addToCart({...item, quantity: selectedQuantity })} style={styles.button}>
                    <Image style={[styles.icon, { width: 16 }]} source={require("../assets/images/iconFooter/material-symbols--add-rounded.png")} />
                </TouchableOpacity>
            </View>
